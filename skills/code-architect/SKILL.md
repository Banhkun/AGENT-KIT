...
description: >-
  ...
  specific files to create or modify, component designs, data flows, and build
  sequences. Use this skill when the user wants to design, architect, or plan
  the structure of a new feature or refactoring, or when they need a technical
...
technology stack, module boundaries, abstraction layers, and project guidelines.
...
Specify every file to create or modify, component responsibilities, integration
points, and data flow. Break implementation into clear phases with specific tasks.
...
specific and actionable — provide file paths, function names, and concrete steps.
